...
def print_image(vector_array, f_array, breesenham):
    image = np.zeros((512, 512, 3), dtype=np.uint8)
    if breesenham is True:
        for first, second, third in f_array:
            line(image, vector_array[first - 1, 0], vector_array[first - 1, 1], vector_array[second - 1, 0],
                 vector_array[second - 1, 1])
            line(image, vector_array[first - 1, 0], vector_array[first - 1, 1], vector_array[third - 1, 0],
                 vector_array[third - 1, 1])
            line(image, vector_array[third - 1, 0], vector_array[third - 1, 1], vector_array[second - 1, 0],
                 vector_array[second - 1, 1])
    else:
        for first, second, third in f_array:
